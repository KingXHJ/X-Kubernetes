...
az vm create -g $rg -n $clientvm --image $vmimage --nics $clientnic --size $size --authentication-type password --admin-username $adminuser --admin-password $adminpwd --use-unmanaged-disk --storage-sku Standard_LRS --os-disk-size-gb 30
